			...
			<div class="card-body pb-2">
				...
				<div class="row form-group">
					...
					<div class="col-md-6">
						...
						<div class="custom-control custom-radio">
							<input <?= set_radio('role', 'mahasiswa'); ?> value="mahasiswa" type="radio" id="mahasiswa" name="mahasiswa" class="custom-control-input">
							<label class="custom-control-label" for="mahasiswa">Mahasiswa</label>
						</div>
						<div class="custom-control custom-radio">
							<input <?= set_radio('role', 'dosen'); ?> value="dosen" type="radio" id="dosen" name="mahasiswa" class="custom-control-input">
							<label class="custom-control-label" for="dosen">Dosen</label>
						</div>
						<?= form_error('dosen', '<span class="text-danger small">', '</span>'); ?>
					</div>
				</div>
				<br>
