...
class Laporan extends CI_Controller
{
	...
	private function _cetak($data, $table_, $tanggal)
	{
		...
		if ($table_ == 'barang_masuk') :
			...
			$pdf->Ln(60);
			$pdf->Cell(75);
			$pdf->Cell(150, 7, 'Bandung, ' . date('d-m-y'), 0, 1, 'C');
			$pdf->Cell(75);
			$pdf->Cell(150, 7, 'Kepala Gudang,', 0, 1, 'C');
			$pdf->Ln(20);
			$pdf->Cell(75);
			$pdf->SetFont('Times', 'B', 15);
			// $pdf->Cell(270, 7, $d['nama'], 0, 1, 'C');
		...
		// $pdf->Cell(270, 7, 'NIP. 19601113 198603 1 003,', 0, 1, 'C');
			...
			$pdf->Ln(60);
			$pdf->Cell(75);
			$pdf->Cell(270, 7, 'Bogor, ' . date('d-m-y'), 0, 1, 'C');
			$pdf->Cell(75);
			$pdf->Cell(270, 7, 'Laboran Farmasi,', 0, 1, 'C');
			$pdf->Ln(20);
			$pdf->Cell(75);
			$pdf->SetFont('Times', 'B', 15);
			// $pdf->Cell(270, 7, 'Nama', 0, 1, 'C');
			$pdf->SetFont('Times', '', 12);
			$pdf->Cell(75);
		// $pdf->Cell(270, 7, 'NIP. 19601113 198603 1 003,', 0, 1, 'C');
